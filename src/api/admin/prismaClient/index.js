...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/api/admin/prismaClient",
    "api/admin/prismaClient",
  ]
...
path.join(process.cwd(), "src/api/admin/prismaClient/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/api/admin/prismaClient/schema.prisma")

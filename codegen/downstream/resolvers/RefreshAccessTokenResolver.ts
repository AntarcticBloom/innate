...
import { Env } from '@utils' // won't resolve until copied to destination
import { GraphQLError } from 'graphql'
import jwt, { JwtPayload } from 'jsonwebtoken'
import type { PrismaClient } from '@prisma/client'
import { Mutation, Resolver, Ctx } from 'type-graphql'
import { LogOutResolver, type Context, cookieNames } from '@shared' // won't resolve until copied to destination
